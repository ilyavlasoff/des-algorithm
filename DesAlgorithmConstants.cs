...
{
    class DesAlgorithmConstants
    {
        public static List<int> PTranspositionMatrix = new List<int> {      
        ...
        public static List<int> P1TranspositionMatrix = new List<int> {
        ...
        public static List<List<List<int>>> SBox = new List<List<List<int>>>()
        {
             new List<List<int>> {
             ...
             new List<List<int>> {
                  ...
                  new List<int> {13, 6, 4, 9, 8, 15, 3, 0, 11, 12, 12, 5, 10, 14, 7},
        ...
        public static List<int> PBox = new List<int>() {
             16, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23, 26, 5, 18, 31, 10,
             2, 8, 24, 14, 32, 27, 3, 9, 19, 13, 30, 6, 22, 11, 4, 25
        };

        public static List<List<int>> ExtendedKeyReplacement = new List<List<int>>{
             new List<int> {
        ...
        public static List<int> KeyCompressionReplacement = new List<int>() {
